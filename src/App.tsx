...
const proof =
  "aca7034a9fcc4c94795ccd0a62cb40e030120d98c15b0a594bc86d972b9b8dfd";
enum View {
  LANDING = 0,
  CONNECT = 1,
  CONNECTED = 2,
...
function App() {
  ...
  const handleSign = () => {
    ...
    //     {
    //       address:
    //         "0:d0d8b39a96377f060d4318b827c960d0dd933350b226ab488251c3ea4cc7c22c",
    //       amount: "0",
    //     },
    //   ],
    // });
  ...
  return (
    <div className="flex flex-col h-full min-h-screen w-screen rounded-xl bg-customGrayWallet">
      <button
        className="btn btn-primary rounded-md p-2 my-2 border-2 border-customGrayButton w-50"
        ...
        <div className="flex flex-col flex-grow min-h-full justify-end">
          <div className="components-container mb-2">
            ...
            <div className="flex flex-col bg-white pt-4 pr-8 pb-8 pl-8 gap-4 rounded-t-3xl rounded-b-xl shadow-custom-white">
              <div>
                <h2 className="headline">Telegram Mini App Demo</h2>
              </div>
              <div>
                <p className="text-customGrayText mt-0 mr-0 mb-4 ml-0">
                  Click on the button below and follow the instructions to link
                  your wallet to this telegram mini app demo.
                </p>
                <p className="text-customGrayText mt-0 mr-0 mb-4 ml-0">
                  Softstack is a Web3 software development, cybersecurity and
          ...
          <div className="p-2 mb-4">
            <PrimaryButton title="Connect Your Wallet" callback={skip} />
          </div>
        </div>
      )}
      {view === View.CONNECT && (
        <div className="components-container">
          ...
          >
            ...
            <div className="flex flex-col absolute w-full bottom-0 bg-white pt-4 px-8 pb-14 gap-4 rounded-t-3xl rounded-b-xl shadow-custom-white">
              ...
              />
              <TonConnectModal title="TON Connect" icon={tonConnectIcon} />
              <WalletConnectModal
          ...
          <div className="components-container mb-2">
            ...
            <div className="flex flex-col bg-white pt-4 px-8 pb-2 min-h-fit gap-2 rounded-t-3xl rounded-b-xl shadow-custom-white">
              ...
              <div className="flex justify-center items-center max-w-10 my-0 mx-auto">
                <img className="h-auto max-w-full" src={etherIcon} alt="" />
              </div>
              <div className="flex flex-col items-center">
                ...
                <div className="text-2xl font-bold mb-4">{balance || 0}</div>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-2 p-2 mb-4">
            <PrimaryButton title="Open my Wallet" callback={openWallet} />
            <div>
              <PrimaryButton
                title="Disconnect"
          ...
          <div className="h-screen bg-customGrayWallet rounded-t-xl">
            ...
            <div className="flex flex-col gap-4 p-4">
              <div className="flex flex-col">
                <p className="m-0 text-xl font-semibold">Total Balance</p>
                <p className="m-0 text-5xl font-extrabold">
                  <span className="text-customGrayAddress">ETH</span>
                  {balance || 0}
                </p>
              </div>
